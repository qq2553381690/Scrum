			...
			<div class="row">
				<div class="span6">
					<ul class="nav nav-tabs">
						<li><a href="${pageContext.request.contextPath }/PreNonChecked">未审核</a></li>
						<li class="active"><a href="${pageContext.request.contextPath }/PreChecked">已审核 </a></li> 
					</ul>
				</div>
			</div>
					...
					<tbody>
					    <c:forEach var="i" begin="0" end="${counter }">
					    	<tr>
						    	...
						    	<form action="${pageContext.request.contextPath }/Recharge" method="post" onsubmit="return ok2()">
						    		<td width=75px>
						    	...
						    	<td width=75px>
					    			<form action="${pageContext.request.contextPath }/FailCheck" method="post" onsubmit="return ok()">
							    		<input name="stu_id" value="${result[i][0] }" type="hidden">
